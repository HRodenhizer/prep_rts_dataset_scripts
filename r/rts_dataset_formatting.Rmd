...
-  Update both intersection tests to not find polygons that only touch.
...
Now you are ready to submit `r ifelse(separate_file == TRUE, paste0(str_split(new_data_file, '\\.')[[1]][1], '_formatted.shp'), rts_file)`!